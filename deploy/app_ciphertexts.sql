...
CREATE TABLE `app_ciphertexts` (
  ...
  `ciphertext` text DEFAULT NULL COMMENT '密文内容',
...
) ENGINE=InnoDB AUTO_INCREMENT=137 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='密文管理';
