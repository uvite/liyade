...
INSERT INTO `sys_dict_type` (`dict_id`, `dict_name`, `dict_type`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (103, '供应商状态', 'supplier_status', '0', 'admin', '2023-04-20 11:04:46', '', NULL, NULL);
INSERT INTO `sys_dict_type` (`dict_id`, `dict_name`, `dict_type`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (104, '产品状态', 'product_status', '0', 'admin', '2023-04-20 13:59:13', 'admin', '2023-04-20 13:59:29', NULL);
INSERT INTO `sys_dict_type` (`dict_id`, `dict_name`, `dict_type`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (105, '库存状态', 'stock_status', '0', 'admin', '2023-04-22 17:01:27', '', NULL, NULL);
INSERT INTO `sys_dict_type` (`dict_id`, `dict_name`, `dict_type`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (106, '授权使用状态', 'license_used', '0', 'admin', '2023-05-20 11:45:55', '', NULL, NULL);
INSERT INTO `sys_dict_type` (`dict_id`, `dict_name`, `dict_type`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (107, '授权审核状态', 'license_enabled', '0', 'admin', '2023-05-20 11:47:08', '', NULL, NULL);
INSERT INTO `sys_dict_type` (`dict_id`, `dict_name`, `dict_type`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (108, '密文状态', 'ciphertext_status', '0', 'admin', '2023-05-22 11:23:24', '', NULL, NULL);
COMMIT;
